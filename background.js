...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    if (request.msg === "createWindow") {
        ...
        chrome.windows.create({
            url: "https://concern-frontend-one.vercel.app?teacherDataID=" + request.data.TeacherDataID+"&courseDataID="+request.data.CourseDataID+"&classroomDataID="+request.data.ClassroomDataID,
            type: "normal",
            width: 1280,
            height: 800,
        }, function (newWindow) {
        ...
        console.log("https://concern-frontend-one.vercel.app?teacherDataID=" + request.data.TeacherDataID+"&courseDataID="+request.data.CourseDataID+"&classroomDataID="+request.data.ClassroomDataID);
    }
    else{
